...
LINKEDIN_DESCRIPTION_TIMEOUT_MS: int = int(get("LINKEDIN_DESCRIPTION_TIMEOUT_MS", "12000") or "12000")
...
# Ретраи LLM для адаптации CV (например, при 429 / rate limit)
CV_ADAPTER_LLM_RETRY_DELAY_SEC: int = int(get("CV_ADAPTER_LLM_RETRY_DELAY_SEC", "30") or "30")
CV_ADAPTER_LLM_MAX_RETRIES: int = int(get("CV_ADAPTER_LLM_MAX_RETRIES", "5") or "5")
